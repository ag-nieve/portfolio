...
for(let i = 0; i < dataCollectorButtons.length; i++){
  ...
  dataCollectorButtons[i].addEventListener('mouseover', hoverIconAnimation.bind(this, dataCollectorButtons[i].id))
}

function hoverIconAnimation(id){
  tl.fromTo(`.intro-social #${id} img`, { x: 0, y:0}, {rotation:40, transformOrigin:"center 50%", yoyo: true, repeat:1});
}
